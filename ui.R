...
shinyUI(tagList(dashboardPage(title = "BC Student Outcomes Data Viewer",
  ...
  title = tags$div(class = "banner",
                   a(href = "https://gov.bc.ca",
                     img(src = 'img/BCID_H_rgb_rev.svg',
...
dashboardSidebar(
  ...
  div(style = "display:inline-block;width:0%;padding-left: 10px;", downloadButton("downloadData", "Notes", icon = icon("download"), 
                                                               style = " 
                                                               color: #000;
...
tabsetPanel(
  ...
  tabPanel("Summary", width = "100%",  
  fluidRow(box(id ="summary",
               uiOutput("text1"),
               title = viewMoreTitle(sectionID = "summary",
        ...
        fluidRow(
          ...
          column(width = 6,
                 ...
                 bsTooltip(id = "employed_full_time",
...
#### Satisfaction and further education section--------------
     fluidRow(
       box(id = "dem",
           title = viewMoreTitle(sectionID = "dem_link",
...
tabPanel("Skill Development", width = "100%", fluidRow(
  box(id = "sat", uiOutput ("text3"),
      title = viewMoreTitle(sectionID = "satisfactionlink",
...
tabPanel("Employment", 
         fluidRow(box(id = "emp",
                      title = viewMoreTitle(sectionID = "employmentlink",
                      ...
                      width = 12,
                      collapsed = FALSE,
      fluidRow(column(4, uiOutput("labour"),
                      bsTooltip(id = "labour",
        ...
        column(4, uiOutput("wage"),
               uiOutput("testing")),
        column(4, uiOutput("unemploy_rate"),
               bsTooltip(id = "unemploy_rate",
                         title = "Respondents who were not working but were available and looking for a job.",
                         placement = "top",
                         trigger = "hover")
               )
      ),
      fluidRow(column(12, uiOutput('employment_rate'),
                      bsTooltip(id = "employment_rate",
      ...
      fluidRow(column(6, uiOutput('full_time'),
                      bsTooltip(id = "full_time",
                                title = "Employed 30 hours or more per week at their main job.",
                                placement = "top",
                                trigger = "hover")
                      ),
      ...
      fluidRow(uiOutput("employment_summary")),
           box(width = 12, uiOutput("text_related_job"),
                     ...
                     tags$div(class = "container", style = "background-color: #003366; display:flex; justify-content:center; text-align:center; height:46px;width:100%;",
                              tags$ul(style = "display:flex; flex-direction:row; flex-wrap:wrap; margin:0; list-style:none; align-items:center; height:100%;",
                                      ...
                                      tags$li(a(href = "https://www2.gov.bc.ca/gov/content/home/copyright", "Copyright",
                                                style = "font-size:1em; font-weight:normal; color:white; padding-left:10px; padding-right:10px; border-right:1px solid #4b5e7e;")),
                                      tags$li(a(href = "http://outcomes.bcstats.gov.bc.ca/ContactUs/ContactStudentOutcomes.aspx", "Contact",
                                                style = "font-size:1em; font-weight:normal; color:white; padding-left:10px; padding-right:10px; border-right:1px solid #4b5e7e;"))
                              )
                     )
         )
