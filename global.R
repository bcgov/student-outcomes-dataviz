# Load libraries
library(shiny) ;library(htmlwidgets); library(tidyr); library(shinythemes); library(shinydashboard);library(plotly);library(shinyjs);library(shinycssloaders); library(markdown); library(shinyBS); library(shinyalert); library(dplyr)
options(scipen=999)
